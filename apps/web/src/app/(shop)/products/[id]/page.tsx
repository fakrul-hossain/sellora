          ...
          <div className="bg-white rounded-3xl p-5 sm:p-8 lg:p-10 border border-slate-200/90 shadow-2xs grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="space-y-3">
                ...
                {/* Inline Rating, Social & Stock Bar */}
                <div className="flex flex-wrap items-center gap-3 text-xs border-y border-slate-100 py-3 text-slate-600">
                  ...
                  <span className="text-slate-300">•</span>
                  <a href="#product-tabs" className="text-slate-600 hover:text-brand-primary font-semibold underline decoration-slate-300">
                    {product.qnaCount || 24} Q&As
                  </a>

                  <div className="ml-auto flex items-center gap-2">
                    <button
                      onClick={() => setIsWishlisted(!isWishlisted)}
                      className={`p-2 rounded-xl border transition-all cursor-pointer ${isWishlisted ? 'bg-brand-lightest border-brand-light text-brand-primary' : 'border-slate-200 text-slate-500 hover:text-slate-900'
                        }`}
                      title="Wishlist"
                    >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl border transition-all cursor-pointer ${isCompared ? 'bg-brand-lightest border-brand-light text-brand-dark' : 'border-slate-200 text-slate-500 hover:text-slate-900'
                        }`}
                      title="Compare"
                    >
