        ...
        <div className="max-w-[1536px] mx-auto px-4 space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {categoriesList.map((c) => (
              <div
                key={c.name}
                className="p-5 rounded-2xl bg-white border border-slate-200/80 hover:border-brand-primary shadow-2xs hover:shadow-md transition-all cursor-pointer group"
              >
          ...
          <div className="space-y-4 pt-4">
            <h2 className="text-base font-extrabold text-brand-dark">Popular In Electronics & Accessories</h2>
