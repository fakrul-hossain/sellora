...
export const FeaturedProductCard: React.FC<FeaturedProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="group relative bg-white rounded-3xl p-5 border border-slate-200/80 hover:border-brand-accent shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
      {/* Image Container */}
      <div className="relative aspect-[4/3] w-full rounded-2xl bg-gradient-to-b from-slate-50 to-slate-100 p-6 flex items-center justify-center overflow-hidden">
      ...
      <div className="mt-4 space-y-2">
        ...
        <h3 className="text-sm font-bold text-brand-primary line-clamp-2 group-hover:text-brand-accent transition-colors">
          {product.title}
        </h3>
