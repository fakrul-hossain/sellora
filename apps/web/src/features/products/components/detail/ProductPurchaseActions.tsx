...
import { ShoppingCart, Check, Heart, ArrowLeftRight, CreditCard, Sparkles } from 'lucide-react';
...
export function ProductPurchaseActions({ productId, onOpenEMICalculator }: ProductPurchaseActionsProps) {
  ...
  return (
    <div className="space-y-4 pt-2">
      ...
      >
        ...
        <span>BUY ON EASY 0% EMI (FROM ৳291/MONTH)</span>
      </button>
    </div>
  );
}
