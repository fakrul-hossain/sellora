      ...
      <div className="bg-brand-dark text-brand-lightest text-xs py-3 px-4 border-b border-brand-dark/20">
        <div className="max-w-[1536px] mx-auto flex items-center justify-between sm:justify-end gap-4">
          <div className="flex items-center gap-5 text-[11px] font-bold text-brand-lightest/90 shrink-0 overflow-x-auto scrollbar-hide">
            <Link href="/sellwithsellora" className="hover:text-brand-light transition-colors whitespace-nowrap">Sell With Sellora</Link>
            <Link href="/help" className="hover:text-brand-light transition-colors whitespace-nowrap">Help & Support</Link>
            <Link href="/cart" className="hover:text-brand-light transition-colors whitespace-nowrap">My Orders</Link>
            <Link href="/help" className="hover:text-brand-light transition-colors whitespace-nowrap">Login</Link>
            <Link href="/help" className="hover:text-brand-light transition-colors whitespace-nowrap">Register</Link>
          </div>
        </div>
      </div>
                    ...
                    {CATEGORIES.map((cat) => {
                      ...
                      return (
                        <div
                          ...
                          className={`flex items-center justify-between px-4 py-2.5 text-xs font-semibold cursor-pointer transition-all ${isSelected
